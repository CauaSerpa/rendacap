<?php
    if (!isset($_SESSION['user_id_finalize_registration'])) {
...
<div class="modal-dialog w-100 mx-auto">
    <form id="finalizeRegistrationForm">
        <div class="modal-content">
            <div class="modal-body">
                <h5 class="modal-title">
                    <h4 class="mt-2">
                        <div>Bem-vindo(a),</div>
                        <span>Sua conta foi criada por um <span class="font-weight-bolder">administrador</span>, precisamos que você insira suas informações reais para continuar.</span>
                ...
                <input type="hidden" name="action" value="finalize-registration">
                <div class="divider row"></div>
                <h6 class="mb-0">
                    Já tem uma conta?
            ...
            <div class="modal-footer d-block text-center">
                <button type="submit" id="btnFinalizeRegistration" class="btn-wide btn-pill btn-shadow btn-hover-shine btn btn-primary btn-lg" style="width: 200px;">Criar uma conta</button>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#finalizeRegistrationForm").submit(function(e) {
            e.preventDefault(); // Evita o envio tradicional do formulário

            // Define os botões como variáveis
            finalizeRegistrationButton = $("#btnFinalizeRegistration");
            loaderButton = $("#btnLoader");

            // Desabilitar botão submit e habilitar loader
            finalizeRegistrationButton.addClass("d-none");
            finalizeRegistrationButton.prop("disabled", true);
            ...
            $.ajax({
                type: "POST",
                url: "<?= INCLUDE_PATH_DASHBOARD; ?>back-end/authentication/finalize-registration.php",
                data: formData,
                ...
                success: function(response) {
                    if(response.status == "success") {
                        ...
                        finalizeRegistrationButton.removeClass("d-none");
                        ...
                        // Desabilitar loader e habilitar botão submit
                        finalizeRegistrationButton.removeClass("d-none");
                        finalizeRegistrationButton.prop("disabled", false);
