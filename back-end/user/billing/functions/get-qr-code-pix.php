...
function getQRCodePix($payment_id, $config, $conn) {
    ...
    if($retorno["success"] == true) {
        ...
        $stmt = $conn->prepare("UPDATE tb_voucher_orders SET pix_expiration_date = ?, pix_encoded_image = ?, pix_code = ? WHERE payment_id = ?");
        $stmt->execute([
